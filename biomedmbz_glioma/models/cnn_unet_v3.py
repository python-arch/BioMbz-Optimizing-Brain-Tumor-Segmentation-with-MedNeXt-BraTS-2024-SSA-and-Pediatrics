...
class EncoderBlock(nn.Module):
    ...
    def forward(self, x):
        x = self.block(x)
        return self.skip_block(x), self.downsampling_layer(x)
...
class CNN_UNET_V3(nn.Module):
    def __init__(self):
        super().__init__()
        
        # list_enc_channels = [8, 64, 128, 256, 320, 512]
        # list_enc_repeat = [1, 1, 1, 2, 2, 2]
        
        # list_dec_channels = [8, 32, 64, 128, 256, 512]
        
        
        list_enc_channels = [32, 64, 128, 256, 256, 512]
        list_enc_repeat = [1, 1, 2, 2, 4, 2]
        
        list_dec_channels = [16, 32, 64, 128, 256, 512]
        
        # list_enc_channels = [16, 32, 64, 128]
        # list_enc_repeat = [1, 2, 2, 4]
