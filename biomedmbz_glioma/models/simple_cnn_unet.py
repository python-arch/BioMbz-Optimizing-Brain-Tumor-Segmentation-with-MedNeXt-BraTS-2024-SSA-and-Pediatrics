...
class DeepSupSimpleCNNUNet(SimpleCNNUNet):
    def __init__(
        self,
        list_enc_channels=[32, 64, 128, 256, 320, 512],
        list_enc_repeat=[1, 1, 1, 2, 4, 2],
        list_dec_channels=[16, 32, 64, 128, 256, 512],
        deep_sup_levels=(1, 2, 3),
    ):
        super().__init__(list_enc_channels, list_enc_repeat, list_dec_channels)
